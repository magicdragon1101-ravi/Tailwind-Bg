...
export const prevBg = [
  ...
  <div className="absolute inset-0 top-0 -z-10 h-full w-full bg-white flex items-center justify-center">
    <div className="h-[300px] absolute top-0 left-0 w-[300px] rounded-full bg-blue-500 opacity-20 blur-[100px]"></div>
  </div>,
  <div className="absolute inset-0 top-0 -z-10 h-full w-full bg-white flex items-center justify-center">
    <div className="h-[300px] absolute top-0 right-0 w-[300px] rounded-full bg-blue-500 opacity-20 blur-[100px]"></div>
    <div className="h-[300px] absolute bottom-0 left-0 w-[300px] rounded-full bg-purple-500 opacity-20 blur-[100px]"></div>
  </div>,
